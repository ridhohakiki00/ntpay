...
CREATE TABLE `transactions` (
  ...
  CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`user_email`) REFERENCES `users` (`email`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `users` (
  ...
  `public_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dump completed on 2025-05-19 12:59:55
